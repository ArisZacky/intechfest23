...
<body style="font-family: 'Plus Jakarta Sans','sans-serif';">
    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex md:order-2">
                {{-- jika belum login --}}
                <a href="/login" class="text-white bg-primary-lightblue hover:bg-primary-blue focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</a>
                {{-- jika sudah login --}}
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
                <ul
                    ...
                    <li>
                        <a href="#"
                            class="block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-primary-lightblue md:p-0 md:dark:text-blue-500"
                            aria-current="page">Home</a>
                    </li>
                    <li>
                        <a href="#"
                            class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-primary-lightblue md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">About</a>
                    </li>
                    <li>
                        <a href="#"
                            class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-primary-lightblue md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Services</a>
                    </li>
                    <li>
                        <a href="#"
                            class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-primary-lightblue md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Contact</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="hidden lg:mt-0 lg:col-span-4 lg:flex">
                <svg id="eySQE3VbFja1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <g id="eySQE3VbFja2" transform="matrix(.801023 0 0 0.801024 89.252943 122.95631)">
                        ...
                        <g id="eySQE3VbFja22"
                            transform="matrix(.954886-.296972 0.296972 0.954886-167.986321 102.666566)">
                            <g>
                                <path
                        ...
                        <g id="eySQE3VbFja35"
                            transform="matrix(.968553-.248808 0.248808 0.968553-189.691893 188.20965)">
                            <g>
                                <path
                        ...
                        <g id="eySQE3VbFja47"
                            transform="matrix(.939531 0.342464-.342464 0.939531 288.661303-55.905592)">
                            <g>
                                <path
                            ...
                            <g>
                                <g>
                                    ...
                                    <line x1="321.35" y1="567.77" x2="320.9" y2="567.77"
                                        transform="translate(-4.340212-6.004844)" fill="none" stroke="#fff"
                                        stroke-width="6" stroke-linecap="round" stroke-miterlimit="10" />
                                    ...
                                    <line x1="564.96" y1="542.92" x2="565.29" y2="542.75"
                                        transform="translate(1.790403 3.381873)" fill="none" stroke="#fff"
                                        stroke-width="6" stroke-linecap="round" stroke-miterlimit="10" />
                        ...
                        <g transform="matrix(.999757 0.022026-.022026 0.999757 13.183015-10.104449)">
                            <g id="eySQE3VbFja93"
                                transform="matrix(.995495-.094811 0.094811 0.995495-39.185926 41.936789)">
                                <g>
                                    <path
                                    ...
                                    <g id="eySQE3VbFja100" mask="url(#eySQE3VbFja106)">
                                        <g>
                                            ...
                                            <ellipse rx="18.58" ry="19.58" transform="translate(479.92 284.25)"
                                                fill="#fff" />
                                            <ellipse rx="5.72" ry="5.74" transform="translate(521.39 345.93)"
                                                fill="#fff" />
                                        </g>
    ...
    <section class="bg-white dark:bg-gray-900" data-aos="fade-up" data-aos-duration="1000">
        <div class="container px-6 py-10 mx-auto">
            <h1 class="text-3xl text-center font-semibold text-gray-800 lg:text-4xl dark:text-white">Benefit yang didapat</h1>
            ...
            <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
                <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                    ...
                    <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Piagam dan hadiah</h1>
                ...
                <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                    ...
                    <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Pengalaman</h1>
                ...
                <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                    ...
                    <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Relasi</h1>
