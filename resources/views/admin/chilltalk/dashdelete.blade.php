...
<h1>Daftar Data Yang Dihapus (CT)</h1>
...
<a href="/childtalk-panitia" class="text-white mx-16 bg-sky-400 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-2">Back</a>
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                ...
                <td class="px-6 py-4">
                <a href="/ct/{{$data->id_ct}}/restore" class="font-medium text-lime-700 dark:text-blue-500 hover:underline" >Restore</a>
                </td>
            </tr>
        </tbody>
        @endforeach
