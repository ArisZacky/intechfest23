...
<div id="updateProductModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <!-- Modal body -->
            <form action="{{url('/wdc-update')}}" method="post" enctype="multipart/form-data">
            @csrf
            <input type="hidden" id="edit-id_wdc" name="id_wdc">
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    <div>
                        <label for="edit-nama_peserta" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">NAMA PESERTA</label>
                    ...
                    <div>
                        <label for="edit-foto_identitas" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">FOTO IDENTITAS</label>
...
<script>
    function edit(baris, id) {
        ...
        document.getElementById('edit-foto_identitas').value = td[1].innerText
