                                ...
                                <td class="px-4 py-3">
                                    ...
                                    <div id="apple-imac-27-dropdown"
                                        ...
                                        <ul class="py-1 text-sm" aria-labelledby="apple-imac-27-dropdown-button">
                                            ...
                                            <li>
                                                <button onclick ="hapus('baris{{$loop->iteration}}', '{{$data->id_project}}')" type="button" data-modal-target="deleteModal"
...
<div id="deleteModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form action="{{url('/project-delete')}}" method="post">
            @csrf
            <input type="hidden" id="hapus-id_project" name="id_project">
...
<script>
    function hapus(baris, id){
        ...
        document.getElementById('hapus-id_project').value = id;
    }
</script>
