        ...
        <tbody>
            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                ...
                <td class="px-6 py-4">
                    ...
                    |
                    <a href="/dc-panit-delete/{{$data->id_dc}}" class="font-medium text-red-600 dark:text-blue-500 hover:underline" onclick="return confirm('Anda Yakin ingin Hapus {{$data->peserta['nama_lengkap']}}?')">Delete</a>
                </td>
            </tr>
        </tbody>
        @endforeach
