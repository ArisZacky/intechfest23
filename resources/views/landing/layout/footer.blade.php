    ...
    <div class="mx-auto max-w-screen-xl border-t-[1px] pt-10">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0 w-60">
                <a href="/" class="flex-col items-center">
                    <div class="flex items-center">
                        ...
                        <span
                            class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Intechfest</span>
                    </div>
            ...
            <div>
                ...
                <ul class="text-gray-600 dark:text-gray-400">
                    ...
                    <li>
                        <i class="fa-solid fa-phone mr-1"></i><a href="https://wa.me/+6282340949343"
                            class="hover:underline">+6282340949343 (Ayu Diah)</a>
                    </li>
                </ul>
            </div>
            <div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                <a href="https://instagram.com/intechfest.cc?igshid=MzRlODBiNWFlZA==" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <i class="fa-brands fa-instagram text-xl hover:text-pink-600"></i>
                </a>
                <a href="https://www.youtube.com/@intechfest9009" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <i class="fa-brands fa-youtube text-xl hover:text-red-600"></i>
                </a>
                <a href="mailto:intechfestpnb@gmail.com" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <i class="fa-regular fa-envelope text-xl"></i>
                </a>
                <a href="https://wa.me/+6282340949343" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
